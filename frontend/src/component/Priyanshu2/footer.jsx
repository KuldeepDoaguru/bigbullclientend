...
const Footer = () => {
      ...
      <div className="main-footer ">
        <div className="footer-content bg-white text-center text-lg p-6">
          ...
          <div className="bottom-content flex flex-col lg:flex-row justify-between  text-2xl footer-links gap-20">
            ...
            <div className="columns grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 md:gap-8 lg:gap-8 w-full lg:w-3/4 justify-center items-center mx-auto">
  ...
  <div className='p-0 max-w-56'>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center max-sm:p-2.5 text-xs sm:text-sm text-white max-w-screen-2xl mx-auto">
        <p className="mb-2 md:mb-0 text-base sm:text-lg">&copy; 2024 DOAGuru InfoSystems</p>
        <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <p className="text-sm sm:text-sm">All Rights Reserved <span className="max-sm:hidden">|</span>  </p>
          <p><Link to="/TermCondition" className="tandc text-xs sm:text-lg max-sm:hidden">Terms and Conditions |</Link></p>
          <p><Link to="/PrivacyPolicy" className="policy text-xs sm:text-lg max-sm:hidden">Privacy Policy</Link></p>
        </div>
      </div>
    </div>
      </div>
